...
dataset_settings = ['1_2_3_123']   #特征由三个数据集单独训练的网络生成，但匹配的时候，三个特征组合到一起
for dataset_setting in dataset_settings:

    fe_train_data_123_1 = np.load(rootpath + 'dataset/fe_'+'1'+'/fe_train.npz')
    fe_test_data_123_1 = np.load(rootpath + 'dataset/fe_'+'1'+'/fe_test.npz')

    fe_train_123_1 = fe_train_data_123_1["fe_train"]
    labels_train_123_1 = fe_train_data_123_1["labels_train"]

    fe_test_123_1 = fe_test_data_123_1["fe_test"]
    labels_test_123_1 = fe_test_data_123_1["labels_test"]



    fe_train_data_123_2 = np.load(rootpath + 'dataset/fe_'+'2'+'/fe_train.npz')
    fe_test_data_123_2 = np.load(rootpath + 'dataset/fe_'+'2'+'/fe_test.npz')

    fe_train_123_2 = fe_train_data_123_2["fe_train"]
    labels_train_123_2 = fe_train_data_123_2["labels_train"]

    fe_test_123_2 = fe_test_data_123_2["fe_test"]
    labels_test_123_2 = fe_test_data_123_2["labels_test"]




    fe_train_data_123_3 = np.load(rootpath + 'dataset/fe_'+'3'+'/fe_train.npz')
    fe_test_data_123_3 = np.load(rootpath + 'dataset/fe_'+'3'+'/fe_test.npz')

    fe_train_123_3 = fe_train_data_123_3["fe_train"]
    labels_train_123_3 = fe_train_data_123_3["labels_train"]

    fe_test_123_3 = fe_test_data_123_3["fe_test"]
    labels_test_123_3 = fe_test_data_123_3["labels_test"]

    print(fe_train_123_1.shape)
    print(fe_train_123_2.shape)
    print(fe_train_123_3.shape)

    fe_train = np.vstack((fe_train_123_1,fe_train_123_2,fe_train_123_3))
    labels_train = np.vstack((labels_train_123_1,labels_train_123_2,labels_train_123_3))


    fe_test = np.vstack((fe_test_123_1, fe_test_123_2, fe_test_123_3))
    labels_test = np.vstack((labels_test_123_1, labels_test_123_2, labels_test_123_3))

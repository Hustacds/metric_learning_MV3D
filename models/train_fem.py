...
if __name__ == "__main__":
    if run_mode:
        ...
        with open("/home/ds/MVRCNN/FGR3D/models/feature_exact"+"_"+str(dataset_index+1)+"/acc.txt", "w") as f:
            with open("/home/ds/MVRCNN/FGR3D/models/feature_exact"+"_"+str(dataset_index+1)+"/log.txt", "w")as f2:
                for epoch in range(EPOCHS):
                    ...
                    with torch.no_grad():
                        ...
                        print('Saving model......')
                        torch.save(net.state_dict(), '%s/net_%03d.pth' % ('/home/ds/MVRCNN/FGR3D/models/feature_exact'+"_"+str(dataset_index+1), epoch + 1))
        ...
        with torch.no_grad():
            net.load_state_dict(torch.load('/home/ds/MVRCNN/FGR3D/models/feature_exact'+"_"+str(dataset_index+1)+'/net_010.pth'))
            net.eval()
            fe_train = []
            labels_train = []
